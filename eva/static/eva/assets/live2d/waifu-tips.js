...
live2d_settings['waifuToolFont']        = '36px';       // 工具栏字体，例如 '14px', '36px'
live2d_settings['waifuToolLine']        = '46px';       // 工具栏行高，例如 '20px', '36px'
...
// 其他杂项设置
live2d_settings['l2dVersion']           = '1.4.idcard2.png';        // 当前版本
live2d_settings['l2dVerDate']           = '2018.11.12'; // 版本更新日期
live2d_settings['homePageUrl']          = '';       // 主页地址，可选 'auto'(自动), '{URL 网址}'
live2d_settings['aboutPageUrl']         = 'http://127.0.0.1:8000/eva/ai';   //https://www.fghrsh.net/post/123.html// 关于页地址, '{URL 网址}'
...
$.ajaxSetup({
    ...
    $('.waifu-tool .fui-info-circle').click(function (){
        ...
        var csrftoken = getCookie('csrftoken');
        $.ajax({
             url: live2d_settings.aboutPageUrl,
             type: 'get',
             ...
             success: function (data) {
                 ...
                 showMessage(data["speak"],6000,data["flag"])
                 if (data["flag"]) {
...
function loadModel(modelId, modelTexturesId=0) {
    ...
    } loadlive2d('live2d',live2d_settings.modelAPI+'get/?id='+modelId+'-'+modelTexturesId, (live2d_settings.showF12Status ? console.log('[Status]','live2d','模型',modelId+'-'+modelTexturesId,'加载完成'):null) );//live2d_settings.modelAPI+'get/?id='+modelId+'-'+modelTexturesId, (live2d_settings.showF12Status ? console.log('[Status]','live2d','模型',modelId+'-'+modelTexturesId,'加载完成'):null)
}///upload/Violet/14.json
